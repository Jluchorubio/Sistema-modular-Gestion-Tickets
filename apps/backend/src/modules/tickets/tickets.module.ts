...
@Module({
  ...
  providers: [TicketsService, MeetingsService, SlaService, SlaEvaluatorService, SlaBreachService, PriorityEngineService, AssignmentService, RoundRobinStrategy, SkillBasedStrategy],
