...
import { GESTION_NAV, GESTION_MODULE_NAME, isGestionModule } from '@/app/(app)/requests/_nav';
...
export default function GestionUserProfilePage() {
  ...
  return (
    <ProfileView
      ...
      onBack={() => router.push('/requests/users')}
    />
  );
}
